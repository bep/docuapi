...
$(codeSelectorPrefix+language).parentsUntil(".highlight").show();$(".lang-specific."+language).parentsUntil(".highlight").show();window.recacheHeights();if($(window.location.hash).get(0)){$(window.location.hash).get(0).scrollIntoView(true);}}
